...
| --- | --- | --- |
| c-summary-1 | Comparable workflows require source-backed evidence. | source-a |

## Competitor Matrix

| Claim ID | Competitor Or Alternative | Relevant Capability | Source IDs | Gap Or Risk | Implication |
| --- | --- | --- | --- | --- | --- |
| c-comp-1 | Comparable workflow | Source-backed research review | source-missing | Manual review can delay urgency. | Keep the next step timeboxed. |
