...
| --- | --- | --- | --- |
| c-mainstream-1 | Mainstream practice favors cited analysis before reserving engineering effort. | source-a | Exact staffing needs remain unknown. |
...
- Claim ID: c-defer-1
- Source IDs: source-a
- Evidence-backed case: Defer when the source-backed evidence does not justify implementation planning.
